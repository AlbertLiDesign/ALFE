...
namespace ALFE
{
    public class Quadrilateral : Element
    {
        ...
        public void ComputeB(double s, double t)
        {
            ...
            B = DenseMatrix.OfArray(new double[3, 8]
            {
            ...
            J = DenseMatrix.OfArray(X).Multiply(DenseMatrix.OfArray(matJ)).Multiply(DenseMatrix.OfArray(Y))[0, 0] * 0.125;
            B = (Matrix)B.Multiply(1.0 / J);
        }
